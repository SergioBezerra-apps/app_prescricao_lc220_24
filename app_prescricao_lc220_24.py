...
st.header("🧮 Calculadora de Prescrição")

# --- Menu lateral ---
menu = st.sidebar.radio(
    "Navegação",
    ["Calculadora", "Apresentação", "FAQ", "Manual de Uso", "Quadros"]
)

# --- Lógica de navegação ---
if menu == "Calculadora":
    # Aqui entra TODO o código da calculadora
    ...
    # Página em branco para futuras implementações
    st.header(menu)
    st.write("🔧 Esta página ainda está em construção.")